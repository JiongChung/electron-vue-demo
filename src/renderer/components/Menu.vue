<template>
    <div class="menu" style="background: blue">
        <el-menu :default-active="activeIndex" class="el-menu-demo" mode="horizontal" @select="handleSelect">
            ...
            <el-menu-item index="4"><a href="https://www.ele.me" @click.prevent="openUrl($event)">订单管理</a></el-menu-item>
        </el-menu>
    </div>
</template>
...
<script>
    export default {
        ...
        mounted () {
            ...
            console.log(document.querySelector('.menu').clientHeight);
        },
        methods: {
            ...
            openUrl(e){
                this.$electron.shell.openExternal(e.srcElement.href);
            }
        }
    }
</script>